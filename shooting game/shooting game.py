...
YELLOW_SPACESHIP_IMAGE=pygame.image.load(os.path.join('Assets', 'yellow ship.png'))
RED_SPACESHIP_IMAGE=pygame.image.load(os.path.join('Assets', 'red ship.png'))

YELLOW_SPACESHIP=pygame.transform.rotate(
    pygame.transform.scale(YELLOW_SPACESHIP_IMAGE, (Space_SHIP_WIDTH, Space_SHIP_HEIGHT)), 90
)

RED_SPACESHIP=pygame.transform.rotate(
    pygame.transform.scale(RED_SPACESHIP_IMAGE, (Space_SHIP_WIDTH, Space_SHIP_HEIGHT)), 270
)
...
def draw_window(red,yellow,red_bullets,yellow_bullets,red_heath,yellow_health):
    WIN.blit(SPACE, (0, 0))
    pygame.draw.rect(WIN, BLACK, BORDER)

    red_health_text=HEALTH_FONT.render("Health: "+str(red_heath), True , WHITE)
